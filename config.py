...
MODERN_TICKERS: List[str] = [
    ...
    "ADI", "MRVL", "MCHP", "MPWR", "NXPI", "ON", "SWKS", "TER", "ENTG",
    "TSM", "ASML", "STM", "CRUS",
    "ORCL", "ADBE", "CRM", "NOW", "INTU", "WDAY", "ADSK", "ANSS", "SNPS",
    "CDNS", "VEEV", "PAYC", "PCTY", "SPLK", "NTAP", "FFIV", "TYL", "CTSH",
    "ACN", "EFX", "BR", "JKHY", "PANW", "FTNT", "QLYS", "CYBR",
    "NFLX", "DIS", "CMCSA", "FOXA", "FOX", "BKNG", "EXPE", "TRIP", "EBAY",
    "SIRI", "LYV",
    "MELI", "BIDU", "NTES",
    "V", "MA", "PYPL", "AXP", "DFS", "COF", "FIS", "FISV", "GPN", "ADP",
    "PAYX", "NDAQ", "ICE", "CME", "CBOE", "MSCI", "SPGI", "MCO", "MKTX",
    "WU", "LPLA", "RJF",
    "JPM", "BAC", "C", "WFC", "GS", "MS", "USB", "PNC", "BK", "STT",
    "NTRS", "SCHW", "JEF", "FITB", "KEY", "HBAN", "MTB", "RF", "CMA",
    "ZION", "CFG", "TFC", "FHN", "WAL", "SNV", "PNFP", "CFR", "OZK",
    "EWBC", "BOKF", "WBS", "ONB", "WTFC",
    "BLK", "TROW", "BEN", "IVZ", "AMG", "CG", "KKR", "APO", "BX", "ARES",
    "AIG", "ALL", "HIG", "MET", "PRU", "TRV", "CB", "CINF", "PGR", "LNC",
    "UNM", "RGA", "MMC", "AJG", "AON", "WRB", "AFG", "RNR", "MKL", "RE",
    "AXS", "BRO", "CNA", "L", "AFL",
    "UNH", "CI", "HUM", "ELV", "CVS", "WBA", "MCK", "CAH", "COR", "HSIC",
    "PDCO", "HCA", "THC", "UHS", "DVA", "LH", "DGX", "IQV", "ICLR", "CTLT",
    "CRL",
    "JNJ", "PFE", "MRK", "BMY", "ABT", "LLY", "ABBV", "AZN", "NVO", "NVS",
    "SNY", "GSK", "TEVA", "PRGO",
    "AMGN", "GILD", "BIIB", "REGN", "VRTX", "BMRN", "INCY", "JAZZ", "ILMN",
    "DXCM", "PODD", "ALKS", "NBIX", "SRPT", "IONS", "ACAD", "HALO", "LGND",
    "MDT", "SYK", "BSX", "ZBH", "BDX", "BAX", "ISRG", "EW", "HOLX", "RMD",
    "ALGN", "DHR", "TMO", "A", "WAT", "MTD", "BIO", "TFX", "IART",
    "WMT", "COST", "TGT", "HD", "LOW", "KR", "DG", "DLTR", "FIVE", "BBY",
    "ULTA", "TJX", "ROST", "BURL", "KSS", "JWN", "M", "DDS", "BIG", "OLLI",
    "LULU", "NKE", "UA", "UAA", "DECK", "CROX", "COLM", "VFC", "PVH", "RL",
    "TPR", "CPRI", "AAP", "AZO", "ORLY", "LKQ", "POOL",
    "MCD", "SBUX", "YUM", "CMG", "DRI", "QSR", "WEN", "TXRH", "DPZ", "PZZA",
    "CAKE", "EAT",
    "PG", "KO", "PEP", "KHC", "MDLZ", "KMB", "CL", "CHD", "CLX", "EL", "NWL",
    "MO", "PM", "BTI", "STZ", "DEO", "TAP", "BFB", "MNST",
    "GIS", "K", "CPB", "CAG", "MKC", "HRL", "SJM", "TSN", "ADM", "BG", "POST",
    "FLO",
    "F", "GM", "HOG", "BWA", "LEA", "DAN", "MGA", "ALV", "APTV", "VC", "SNA",
    "GPC",
    "BA", "GE", "HON", "MMM", "LMT", "RTX", "GD", "NOC", "LHX", "TDG", "HEI",
    "BWXT", "HII", "PH", "EMR", "ROK", "ROP", "DOV", "ITT", "HUBB", "AME",
    "APH", "ITW", "CAT", "DE", "CMI", "PCAR", "PNR", "AOS", "FLS", "XYL",
    "GNRC", "FAST", "GWW", "MSM", "WSO", "WCC", "IEX", "CGNX", "TRMB", "GRMN",
    "UNP", "CSX", "NSC", "CP", "CNI", "FDX", "UPS", "CHRW", "EXPD", "JBHT",
    "LSTR", "ODFL", "SAIA", "XPO",
    "DAL", "UAL", "AAL", "LUV", "JBLU", "ALK", "SKYW", "ALGT", "HA",
    "XOM", "CVX", "COP", "OXY", "HES", "EOG", "PXD", "DVN", "APA", "MRO",
    "FANG", "EQT", "AR", "RRC", "SWN", "VLO", "MPC", "PSX", "PBF", "SLB",
    "HAL", "BKR", "NOV", "NBR", "PTEN", "RIG", "TS",
    "WMB", "KMI", "EPD", "ET", "MPLX", "OKE", "TRGP", "LNG", "NFG",
    "NEE", "DUK", "SO", "D", "AEP", "EXC", "XEL", "PPL", "ETR", "PCG", "ED",
    "SRE", "PEG", "EIX", "FE", "AEE", "CMS", "CNP", "DTE", "NI", "NRG", "WEC",
    "PNW", "AES", "ATO", "ES", "LNT", "BEP", "NEP",
    "LIN", "APD", "SHW", "ECL", "DD", "DOW", "PPG", "RPM", "FMC", "EMN", "IFF",
    "ALB", "CE", "OLN", "LYB", "WLK", "CF", "MOS", "NTR",
    "FCX", "NEM", "GOLD", "AEM", "KGC", "PAAS", "WPM", "FNV",
    "NUE", "STLD", "CLF", "X", "RS", "CMC", "ATI", "CRS", "AA",
    "VMC", "MLM", "EXP", "IP", "WY", "PKG", "BALL", "SON", "AVY", "BERY",
    "SEE", "LPX",
    "PLD", "AMT", "CCI", "EQIX", "DLR", "SPG", "PSA", "WELL", "AVB", "EQR",
    "VTR", "O", "NNN", "REG", "SLG", "VNO", "BXP", "FRT", "KIM", "HST", "DRH",
    "SHO", "ARE", "ESS", "CPT", "UDR", "MAA", "EXR", "CUBE", "IRM", "STAG",
    "RHP", "OHI", "SBRA", "GLPI",
    "VZ", "T", "TMUS", "CHTR", "LUMN",
    "CSCO", "IBM", "HPQ", "HPE", "WDC", "STX", "JNPR", "AKAM", "CDW",
    "ATVI", "EA", "TTWO", "ZG", "Z", "PARA",
    "SWK", "TXT", "NVT", "FBIN", "SCI", "STE", "CHE", "ATR", "SITE", "BMI",
    "LECO", "HRB", "WEX", "LDOS", "SAIC",
    "ALLY", "CBSH", "FFIN", "OFG", "PBCT", "HTLF", "INDB", "WSFS",
    "ERIE", "NYCB", "VLY", "FNB", "GBCI", "UBSI", "RNST", "SFNC", "FHI",
    "ROL", "GEO", "CXW", "MGR", "WSM", "FL", "GPS", "ANF", "BJRI", "CBRL",
    "BLMN", "RCII",
    "LEN", "PHM", "TOL", "KBH", "MDC", "NVR", "TMHC",
    "AMED", "LHCG", "EXEL", "SGEN", "HZNP", "ENSG", "MYRG", "RGEN", "ITCI",
    "XNCR",
    "EPAM", "NUAN", "IRBT", "VIAV", "PLXS", "SANM", "MKSI", "BRKS", "FORM",
    "RMBS", "TREX", "AAON", "RRX", "EXPO", "AWI", "GATX", "WERN", "MRTN",
    "HTLD", "MRC", "ASTE", "SXT", "HEES", "ARCB",
    "CNX", "CLB", "SM", "NOG", "OVV", "MTDR", "VNOM",
    "TROX", "SMG", "GEF", "GPK", "HWKN", "NEU", "IOSP",
    "OGE", "PNM", "ALE", "IDA", "MGEE", "NJR", "NWN", "AVA", "HE",
    "HIW", "CUZ", "KRC", "BDN", "LTC", "DEI", "ROIC", "EQC",
    "IPG", "OMC", "NYT", "NXST", "GHC", "MGRC", "MSA", "JACK", "BWLD", "DIN",
    "ALLE", "KEYS", "PEGA", "MANH", "SSNC", "AZPN", "ACLS", "MTSI",
    "RHI", "MAN", "KFY", "EXLS", "ICUI", "NHC", "HCI", "CACC", "ORI",
]
# ─────────────────────────────────────────────────────────────────────────────
# DEFAULT_TICKERS = MODERN_TICKERS
